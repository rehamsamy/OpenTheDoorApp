...
public class ScheduledHistoryModel {
    ...
    private ScheduledHistoryData userserviceinfo;
    ...
    public ScheduledHistoryData getUserserviceinfo() {
        return userserviceinfo;
    }


    // Class ScheduledHistoryData ....
    public static class ScheduledHistoryData {

        @SerializedName("scheduled")
        private List<ServiceItemData> scheduled;


        // Getters
        public List<ServiceItemData> getScheduled() {
            return scheduled;
        }
    }
