...
public class CanceledHistoryModel {

    @SerializedName("status")
    private Boolean status;
    @SerializedName("userserviceinfo")
    private CanceledHistoryData userserviceinfo;
    ...
    public CanceledHistoryData getUserserviceinfo() {
        return userserviceinfo;
    }


    // Class CanceledHistoryData ....
    public static class CanceledHistoryData {

        @SerializedName("canceled")
        private List<ServiceItemData> canceled;


        // Getters
        public List<ServiceItemData> getCanceled() {
            return canceled;
        }
    }
